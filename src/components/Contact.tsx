    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <p className="text-zinc-300 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed font-body">
            Need an AI Agent? Need Workflow Automation? Need Backend API Integration? <br />
            Let's discuss how we can build custom automation systems for your business or project.
          </p>

          {/* Download Resume Action inside Contact */}
          <div className="pt-2 flex justify-center">
            <a
              href="/resume-engineering.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full btn-premium-gradient text-xs font-semibold shadow-lg cursor-pointer transition-all hover:scale-[1.02]"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto text-left mt-8">
