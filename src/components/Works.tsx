...
const INVOICE_SVG_DATA = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 1000" width="100%" height="100%" style="background-color:#ffffff; font-family:'Inter', system-ui, sans-serif;">
  <rect width="800" height="1000" fill="#ffffff" />
  <path d="M 0,0 L 800,0 L 800,200 Q 600,260 400,200 T 0,260 Z" fill="url(#blueGrad)" />
  <defs>
    <linearGradient id="blueGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#0F52BA" />
      <stop offset="100%" stop-color="#020056" />
    </linearGradient>
  </defs>
  <text x="60" y="130" fill="#ffffff" font-size="52" font-weight="900" letter-spacing="2">INVOICE</text>
  <text x="740" y="120" fill="#ffffff" font-size="18" font-weight="700" text-anchor="end" opacity="0.9">NO: INV-12345-1</text>
  <text x="80" y="360" fill="#1e293b" font-size="20" font-weight="bold">Bill To:</text>
  <text x="80" y="395" fill="#475569" font-size="16">Estelle Darcy</text>
  <text x="80" y="425" fill="#475569" font-size="16">+123-456-7890</text>
  <text x="80" y="455" fill="#475569" font-size="16">123 Anywhere St., Any City</text>
  <text x="480" y="360" fill="#1e293b" font-size="20" font-weight="bold">From:</text>
  <text x="480" y="395" fill="#475569" font-size="16">Samira Hadid</text>
  <text x="480" y="425" fill="#475569" font-size="16">+123-456-7890</text>
  <text x="480" y="455" fill="#475569" font-size="16">123 Anywhere St., Any City</text>
  <text x="80" y="540" fill="#475569" font-size="16" font-weight="bold">Date: 26 June 2022</text>
  <rect x="80" y="590" width="640" height="45" fill="#0F52BA" rx="6" />
  <text x="100" y="618" fill="#ffffff" font-size="15" font-weight="bold">Description</text>
  <text x="400" y="618" fill="#ffffff" font-size="15" font-weight="bold" text-anchor="middle">Qty</text>
  <text x="520" y="618" fill="#ffffff" font-size="15" font-weight="bold" text-anchor="middle">Price</text>
  <text x="680" y="618" fill="#ffffff" font-size="15" font-weight="bold" text-anchor="middle">Total</text>
  <line x1="80" y1="675" x2="720" y2="675" stroke="#e2e8f0" stroke-width="1.5" />
  <text x="100" y="710" fill="#475569" font-size="15">Intelligent Automation Setup</text>
  <text x="400" y="710" fill="#475569" font-size="15" text-anchor="middle">1</text>
  <text x="520" y="710" fill="#475569" font-size="15" text-anchor="middle">$1,250.00</text>
  <text x="680" y="710" fill="#475569" font-size="15" text-anchor="middle">$1,250.00</text>
  <line x1="80" y1="755" x2="720" y2="755" stroke="#e2e8f0" stroke-width="1.5" />
  <text x="100" y="790" fill="#475569" font-size="15">n8n Custom Workflow Integration</text>
  <text x="400" y="790" fill="#475569" font-size="15" text-anchor="middle">1</text>
  <text x="520" y="790" fill="#475569" font-size="15" text-anchor="middle">$1,750.00</text>
  <text x="680" y="790" fill="#475569" font-size="15" text-anchor="middle">$1,750.00</text>
  <rect x="420" y="845" width="300" height="45" fill="#0F52BA" rx="6" />
  <text x="440" y="873" fill="#ffffff" font-size="15" font-weight="bold">Sub Total / Total Due</text>
  <text x="700" y="873" fill="#ffffff" font-size="15" font-weight="bold" text-anchor="end">$3,000.00</text>
  <text x="80" y="875" fill="#0F52BA" font-size="28" font-weight="bold">Thank You!</text>
</svg>`)}`;
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 sm:space-y-4 mb-10 sm:mb-16">
          ...
          />
          <p className="text-zinc-400 text-xs sm:text-base leading-relaxed font-body max-w-2xl mx-auto">
